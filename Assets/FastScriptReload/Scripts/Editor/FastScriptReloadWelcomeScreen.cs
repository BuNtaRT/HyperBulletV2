...
2) Edit -> Preferences... -> Fast Script Reload", screen.TextStyle, GUILayout.ExpandHeight(true));
                ...
                using (LayoutHelper.LabelWidth(350))
                {
                    ...
                    using (new EditorGUI.DisabledGroupScope((bool)FastScriptReloadPreference.WatchOnlySpecified
...
Choose other tab on the left.", screen.TextStyle);
                        ...
                        GUILayout.Label(
                            "1) Review compilation error, especially looking for specific lines that caused error:");
                        EditorGUILayout.HelpBox(
...
Output: '<filepath>.SourceCodeCombined.cs(940,1): error CS1027: #endif directive expected'",
                        ...
                        if (GUILayout.Button("2) Click here to open generated file that failed to compile"))
                        {
                            InternalEditorUtility.OpenFileAtLineExternal(
                                LastInspectFileHotReloadStateError.SourceCodeCombinedFilePath, 1);
                        }
...
custom rewrites for methods.", screen.BoldTextStyle);
                        ...
                        {
                            ScriptGenerationOverridesManager.AddScriptOverride(
                                new FileInfo(FastScriptReloadWelcomeScreen.LastInspectFileHotReloadStateError
                                    .FullFileName));
                        }
                        ...
                        EditorGUILayout.HelpBox(
                            @"Could you please assist in improving the tool by providing me with the details of the error? 
...
3) Error message", MessageType.Warning);
                        ...
                        if (GUILayout.Button("4) Click here to create support-pack"))
                        {
                            try
                            {
                                ...
                                var sourceCodeCombinedFile =
                                    new FileInfo(LastInspectFileHotReloadStateError.SourceCodeCombinedFilePath);
                                var originalFile = new FileInfo(LastInspectFileHotReloadStateError.FullFileName);
                                File.Copy(LastInspectFileHotReloadStateError.SourceCodeCombinedFilePath,
                                    Path.Combine(folder, sourceCodeCombinedFile.Name));
                                File.Copy(LastInspectFileHotReloadStateError.FullFileName,
                                    Path.Combine(folder, originalFile.Name));
                                File.WriteAllText(Path.Combine(folder, "error-message.txt"),
                                    LastInspectFileHotReloadStateError.ErrorText);

                                EditorUtility.DisplayDialog("Support Pack Created",
                                    $"Thanks!\r\n\r\nPlease send files from folder:\r\n'{folder}'\r\n\r\nto:\r\n\r\nsupport@immersivevrtools.com",
                    ...
                    new ChangeMainViewButton("Reload", (screen) =>
                    {
                        ...
                        using (LayoutHelper.LabelWidth(320))
                        {
                            ProductPreferenceBase.RenderGuiAndPersistInput(
                                FastScriptReloadPreference.WatchOnlySpecified);
                        }

                        if ((bool)FastScriptReloadPreference.WatchOnlySpecified.GetEditorPersistedValueOrDefault())
                        {
                            EditorGUILayout.HelpBox(
                                @"With manual watching you need to right click on file/folder in project window and select 'Watch File'",
                                MessageType.Info);
                        }
...
Use this setting to force lock assemblies via code."
                        ...
                        {
                            ProductPreferenceBase.RenderGuiAndPersistInput(FastScriptReloadPreference
                                .IsVisualHotReloadIndicationShownInProjectWindow);
                        }
      ...
      (it needs to be clicked in bottom details pane, double click will simply take you to log location)",
                        ...
                        using (LayoutHelper.LabelWidth(350))
                        {
                            ...
                            if ((bool)FastScriptReloadPreference.IsAutoOpenGeneratedSourceFileOnChangeEnabled
                                    .GetEditorPersistedValueOrDefault())
                            {
                                EditorGUILayout.HelpBox(@"Do not edit debug file created. It'll be removed.",
                                    MessageType.Error);
                            }
                        }
...
This is to ensure dynamically created and loaded assembles are cleared out properly", MessageType.Info);
                    ...
                    new ChangeMainViewButton("Partial Class", (screen) =>
                    {
                        ...
                        {
                            ProductPreferenceBase.RenderGuiAndPersistInput(FastScriptReloadPreference
                                .IsPartialClassSupportEnabled);
                        }

                        EditorGUILayout.HelpBox(
                            "Partial class support can be file-read heavy which could make FSR slower.",
                            MessageType.Warning);
                    })
                }),
...
{FastScriptReloadManager.FileWatcherReplacementTokenForApplicationDataPath} - you can use that token and it'll be replaced with your /Assets folder"
                        ...
                        {
                            ProductPreferenceBase.RenderGuiAndPersistInput(FastScriptReloadPreference
                                .FileWatcherImplementationInUse);
                        }
...
CustomPolling - (experimental) watches files by manual polling for changes, slowest. Make sure to narrow down watchers scope to script folders",
    ...
    public class FastScriptReloadPreference : ProductPreferenceBase
    {
        ...
        public static readonly IntProjectEditorPreferenceDefinition BatchScriptChangesAndReloadEveryNSeconds =
        ...
        public static readonly ToggleProjectEditorPreferenceDefinition EnableOnDemandReload =
            new ToggleProjectEditorPreferenceDefinition(
                "Enable on demand hot reload", "EnableOnDemandReload", false);

        public static readonly ToggleProjectEditorPreferenceDefinition EnableExperimentalThisCallLimitationFix =
            new ToggleProjectEditorPreferenceDefinition(
                "(Experimental) Enable method calls with 'this' as argument fix",
                "EnableExperimentalThisCallLimitationFix", true,
        ...
        public static readonly StringListProjectEditorPreferenceDefinition FilesExcludedFromHotReload =
            new StringListProjectEditorPreferenceDefinition(
                "Files excluded from Hot-Reload", "FilesExcludedFromHotReload", new List<string> { }, isReadonly: true);

        public static readonly StringListProjectEditorPreferenceDefinition ReferencesExcludedFromHotReload =
            new StringListProjectEditorPreferenceDefinition(
        ...
        public static readonly ToggleProjectEditorPreferenceDefinition LogHowToFixMessageOnCompilationError =
            new ToggleProjectEditorPreferenceDefinition(
        ...
        public static readonly ToggleProjectEditorPreferenceDefinition DebugWriteRewriteReasonAsComment =
            new ToggleProjectEditorPreferenceDefinition(
        ...
        public static readonly ToggleProjectEditorPreferenceDefinition StopShowingAutoReloadEnabledDialogBox =
            new ToggleProjectEditorPreferenceDefinition(
                "Stop showing assets/script auto-reload enabled warning", "StopShowingAutoReloadEnabledDialogBox",
                false);

        public static readonly ToggleProjectEditorPreferenceDefinition EnableDetailedDebugLogging =
            new ToggleProjectEditorPreferenceDefinition(
                "Enable detailed debug logging", "EnableDetailedDebugLogging", false,
                (object newValue, object oldValue) =>
                {
                    BuildDefineSymbolManager.SetBuildDefineSymbolState(BuildSymbol_DetailedDebugLogging,
                        (bool)newValue);
                },
                (value) =>
                {
        ...
        public static readonly ToggleProjectEditorPreferenceDefinition IsVisualHotReloadIndicationShownInProjectWindow =
            new ToggleProjectEditorPreferenceDefinition(
                "Show red / green bar in project window to indicate hot reload state for file",
                "IsVisualHotReloadIndicationShownInProjectWindow", true);

        public static readonly ToggleProjectEditorPreferenceDefinition IsPartialClassSupportEnabled =
            new ToggleProjectEditorPreferenceDefinition(
                "(Experimental) Partial class support", "IsPartialClassSupportEnabled", true);

        public static readonly ToggleProjectEditorPreferenceDefinition IsForceLockAssembliesViaCode =
            new ToggleProjectEditorPreferenceDefinition(
        ...
        public static readonly JsonObjectListProjectEditorPreferenceDefinition<FileWatcherSetupEntry>
            FileWatcherSetupEntries = new JsonObjectListProjectEditorPreferenceDefinition<FileWatcherSetupEntry>(
                "File Watchers Setup", "FileWatcherSetupEntries", new List<string>
                {
                    JsonUtility.ToJson(new FileWatcherSetupEntry(
                        FastScriptReloadManager.FileWatcherReplacementTokenForApplicationDataPath, "*.cs", true))
                },
                () => new FileWatcherSetupEntry(
                    FastScriptReloadManager.FileWatcherReplacementTokenForApplicationDataPath, "*.cs", true)
            );

        public static readonly ToggleProjectEditorPreferenceDefinition EnableExperimentalAddedFieldsSupport =
            new ToggleProjectEditorPreferenceDefinition(
        ...
        public static readonly ToggleProjectEditorPreferenceDefinition EnableExperimentalEditorHotReloadSupport =
            new ToggleProjectEditorPreferenceDefinition(
                "(Experimental) Enable Hot-Reload outside of play mode", "EnableExperimentalEditorHotReloadSupport",
                false);

        [Obsolete("Use EnableExperimentalEditorHotReloadSupport instead")]
        public static readonly ToggleProjectEditorPreferenceDefinition EnableCustomFileWatcher =
            new ToggleProjectEditorPreferenceDefinition(
                "(Experimental) Use custom file watchers", "EnableCustomFileWatcher", false);

        public static readonly EnumProjectEditorPreferenceDefinition FileWatcherImplementationInUse =
            new EnumProjectEditorPreferenceDefinition(
                "File Watcher implementation", "FileWatcherImplementationInUse", FileWatcherImplementation.UnityDefault,
                typeof(FileWatcherImplementation));
        ...
        public static readonly IntProjectEditorPreferenceDefinition
            TriggerDomainReloadIfOverNDynamicallyLoadedAssembles = new IntProjectEditorPreferenceDefinition(
        ...
        public static readonly ToggleProjectEditorPreferenceDefinition WatchOnlySpecified =
            new ToggleProjectEditorPreferenceDefinition(
    ...
    public class FastScriptReloadWelcomeScreenInitializer : WelcomeScreenInitializerBase
    {
        ...
        static FastScriptReloadWelcomeScreenInitializer()
        {
            ...
            HandleUnityStartup(
                ...
                new List<ProjectEditorPreferenceDefinitionBase>(),
                (isFirstRun) => { MigrateObsoleteEnableCustomFileWatcherPreference(); }
            );
...
#pragma warning disable CS0618 // Type or member is obsolete
            ...
            {
                FastScriptReloadPreference.FileWatcherImplementationInUse.SetEditorPersistedValue(
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected static void InitCommon()
        {
            ...
            BuildDefineSymbolManager.SetBuildDefineSymbolState(
                FastScriptReloadPreference.BuildSymbol_DetailedDebugLogging,
        ...
        private static void EnsureUserAwareOfAutoRefresh()
        {
            ...
            var chosenOption = EditorUtility.DisplayDialogComplex("Fast Script Reload - Warning",
                ...
                "Ok, disable asset auto refresh (manually)",
                "No, don't change (stop showing",
                "No, don't change"
            );
